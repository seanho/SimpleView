describe "UIActivityIndicatorViewBuilder" do
  it "should build UIActivityIndicatorView" do
    view = Simple::UIActivityIndicatorViewBuilder.new.build(UIActivityIndicatorView)
  ...
  it "should build UIActivityIndicatorView with style" do
    view = Simple::UIActivityIndicatorViewBuilder.new.build(UIActivityIndicatorView, style: UIActivityIndicatorViewStyleGray)
